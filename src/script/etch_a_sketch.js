...
function addScrollingTextBox() {
  ...
  scrollText.innerText =
    "Welcome to my Etch-a-Sketch Game! Enjoy drawing and have fun! The goal is to create beautiful sketches with just your mouse! " +
    scrollString();
...
function scrollString() {
  return `
    ...
    In the kingdom of Lothric, a knight named jack jackolson stood as the realm’s greatest warrior. 
Stronger than any other knight, jack wasn’t just skilled with the sword. He was also a brilliant programmer, 
a master of code and technology in an age where such things didn’t exist. While the knights wielded steel, 
jack wielded Ironbyte, a massive sword charged with digital energy—a fusion of ancient steel and advanced programming.
...
jack, who had been investigating these anomalies, soon discovered that Meta Knight’s influence was spreading. 
It wasn’t just Lothric that was in danger—dimensions were colliding. jack’s investigation led him to a new, unstable reality: 
...
There, jack encountered A2, a rogue android from a world far beyond, one where humanity had been all but wiped out, 
...
jack nodded, understanding. He wasn’t just fighting for Lothric anymore—he was fighting for the survival of all worlds.
...
"You’re too late, jack jackolson," Meta Knight’s voice echoed. "All worlds will become one. Your time has passed."

But jack didn’t flinch. His mind raced, analyzing the situation. This wasn’t just a battle of strength. 
...
With A2’s help, jack faced the monstrous mech and its corrupted master. 
As Meta Knight unleashed waves of energy, jack fought back using both his Ironbyte and his ability to manipulate code. 
Every strike of his sword sent shockwaves of digital power through the world, hacking the very fabric of reality itself.

As the battle raged, a sudden realization hit jack. He wasn’t just facing Meta Knight. 
The Sigil was distorting the very concept of time and space—allowing beings from countless realms to merge and clash. 
He needed to act fast.

jack accessed the Sigil’s core, hidden deep within the beast’s Eva-like mech. 
...
A final surge of energy blasted from Meta Knight’s Galactic Blade, but jack, in a last-ditch effort, severed the Sigil’s connection just in time. 
...
With one mighty strike of Ironbyte, jack cleaved through the last remnants of Meta Knight’s form, sending him into oblivion.

The sky returned to normal. The twisted worlds began to heal, and the dimensions slowly pulled back into place. 
A2, standing amidst the ruins, looked at jack with a quiet nod, as if acknowledging his victory. 
"You’ve saved them all. Even if it doesn’t feel like enough.”

jack sheathed his sword, his eyes scanning the horizon where other worlds—still scarred—faded away into nothingness. 
"The fight’s never over," he replied, his voice determined. "But today, we’ve won."

And so, jack jackolson, the most powerful knight and the savior of countless realities, returned to Lothric Castle, 
